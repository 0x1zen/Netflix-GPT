  ...
  return (
    <div className='relative w-full h-screen bg-center bg-cover' style={{ backgroundImage: `url("https://static1.moviewebimages.com/wordpress/wp-content/uploads/2024/08/netflix-logo.jpeg")` }}>
      ...
      <form onSubmit={(e) => {
        ...
        <input type="text" placeholder="Email Address" className='text-white p-2 m-2 bg-gray-800 w-70'></input>
        <input type="text" placeholder="Password" className='text-white p-2 m-2  bg-gray-800 w-70'></input>
        <button className='p-4 m-4 text-white bg-red-500 w-70 font-bold hover:bg-red-900 transition'>{isSignIn ? "Sign In" : "Sign Up"}</button>
